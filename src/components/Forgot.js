      ...
      <div className="row">
        <div className="col-8 scrollable">
          ...
          <div className="container mw-560">
            ...
            <hr />
            <div className="row">
              <div className="col-12 m-b-34"><a className="back-to-login" href="/auth/sign-in">BACK TO LOGIN</a></div>
              <div className="col-12">
                <form id="sign_in_form">
                  <div className="form-group m-0">
                    <input className="form-control-lg forn-trans form-control" id="email" name="email" placeholder="ENTER YOUR EMAIL" required type="email" />
                  </div>
                  <p className="you-will-get-your-pa">You will get your password reminder</p>
                  <div className="t-center">
                    <button className="btn btn-lg btn-primary" type="submit">GET RESET GUIDE</button>
                  </div>
                </form>
              </div>
            </div>
